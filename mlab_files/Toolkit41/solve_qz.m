...
if abs(det(UUU_2_1)) < TOL,
   error('SOLVE_QZ.M: A necessary condition for the validity of the formula for the matrix PP is not satisfied.')
...
if abs(det(VVV_2_1)) < TOL,
   error('SOLVE_QZ.M: A matrix which I need to invert for calculating PP is not invertible.')
